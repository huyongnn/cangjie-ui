window.CANGJIE_FINAL_LOCKED_STORAGE = {
  ...
  "seed_revision": "V1_RELEASE_CUSTOMER_LOGIN_001",
  ...
  "localStorage": {
    ...
    "tudou2_v57_persistent_data": "{\"goodsMaster\":[],\"batches\":[],\"owners\":[],\"cashierCustomers\":[{\"id\":\"c1\",\"name\":\"临时客户\",\"debt\":0,\"payments\":[],\"parentId\":\"\",\"disabled\":false}],\"savedCodeBills\":[],\"finalOrders\":[],\"buyerV47List\":{},\"activeBatchId\":\"\",\"cashierSelectedBatch\":\"\",\"cashierSelectedCat\":\"全\",\"savedAt\":\"V1_RELEASE_CUSTOMER_LOGIN_001\",\"orders\":[],\"codeBills\":[],\"buyerV47Orders\":[],\"buyerV47Repayments\":[],\"repayments\":[]}",
    "tudou2_v58_inventory_orders_data": "{\"finalOrders\":[],\"batches\":[],\"savedAt\":\"V1_RELEASE_CUSTOMER_LOGIN_001\"}",
    "cangjieMerchantLoginV92": "{\"loggedIn\":false,\"mode\":\"phone\",\"phone\":\"\",\"wechat\":\"\",\"time\":\"V1_RELEASE_CUSTOMER_LOGIN_001\",\"localMock\":true}",
    "cangjie_system_version": "V1_FINAL_LOCKED",
    "cangjie_seed_source": "storage.js",
    "cangjie_seed_revision": "V1_RELEASE_CUSTOMER_LOGIN_001",
    "cangjieCommercialSyncV1": "{\"merchantId\":\"\",\"userId\":\"\",\"deviceId\":\"dev_local_seed_7wgjwi\",\"role\":\"owner\",\"deploymentMode\":\"cangjie_cloud\",\"databaseSource\":\"仓颉云 Supabase\",\"syncVersion\":2,\"lastSyncAt\":\"\",\"syncEnabled\":true,\"autoSyncEnabled\":false,\"autoSyncMode\":\"manual\",\"lastAutoSyncAt\":null,\"lastAutoSyncResult\":\"尚未自动上传\",\"lastCloudOrderSyncAt\":null,\"lastCloudOrderSyncResult\":\"尚未同步订单\",\"cloudStatus\":\"未连接\",\"dataUpdatedAt\":\"V1_RELEASE_CUSTOMER_LOGIN_001\",\"cloudUpdatedAt\":\"\",\"offlineAvailable\":true,\"conflictLogs\":[],\"syncLogs\":[{\"id\":\"sync_release_customer_login_001\",\"time\":\"V1_RELEASE_CUSTOMER_LOGIN_001\",\"type\":\"init\",\"status\":\"未连接\",\"message\":\"客户测试版：首次打开显示登录入口；任意手机号本地模拟登录后创建测试商户身份。\"}]}",
    "cangjieDeploymentConfigV1": "{\"deploymentMode\":\"cangjie_cloud\",\"privateSupabaseUrl\":\"\",\"privateSupabaseKey\":\"\",\"updatedAt\":\"V1_RELEASE_CUSTOMER_LOGIN_001\"}",
