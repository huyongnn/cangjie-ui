window.CANGJIE_FINAL_LOCKED_STORAGE = {
  ...
  "seed_revision": "V1_CUSTOMER_TEST_CLEAN_001",
  ...
  "localStorage": {
    ...
    "cangjie_seed_revision": "V1_CUSTOMER_TEST_CLEAN_001",
    "cangjieCommercialSyncV1": "{\"merchantId\":\"mch_08230i\",\"userId\":\"admin\",\"deviceId\":\"dev_local_seed_7wgjwi\",\"role\":\"管理员\",\"deploymentMode\":\"cangjie_cloud\",\"databaseSource\":\"仓颉云 Supabase\",\"syncVersion\":2,\"lastSyncAt\":\"\",\"syncEnabled\":true,\"autoSyncEnabled\":false,\"autoSyncMode\":\"manual\",\"lastAutoSyncAt\":null,\"lastAutoSyncResult\":\"尚未自动上传\",\"lastCloudOrderSyncAt\":null,\"lastCloudOrderSyncResult\":\"尚未同步订单\",\"cloudStatus\":\"未连接\",\"dataUpdatedAt\":\"V1_CUSTOMER_TEST_CLEAN_001\",\"cloudUpdatedAt\":\"\",\"offlineAvailable\":true,\"conflictLogs\":[],\"syncLogs\":[{\"id\":\"sync_seed_customer_clean_001\",\"time\":\"V1_CUSTOMER_TEST_CLEAN_001\",\"type\":\"init\",\"status\":\"未连接\",\"message\":\"客户测试版干净初始状态：无商品、无批次、无订单；默认临时客户可用。\"}]}",
    "cangjieDeploymentConfigV1": "{\"deploymentMode\":\"cangjie_cloud\",\"privateSupabaseUrl\":\"\",\"privateSupabaseKey\":\"\",\"updatedAt\":\"V1_CUSTOMER_TEST_CLEAN_001\"}",
